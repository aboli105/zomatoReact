...
const url = "https://zomatoapi2.herokuapp.com/details"
const menuUrl = "https://zomatoapi2.herokuapp.com/menu"
...
class RestDetails extends Component {
    ...
    render(){
        ...
        async componentDidMount(){
           ...
           console.log(">>>response.data[0].restaurant_id",response.data)
